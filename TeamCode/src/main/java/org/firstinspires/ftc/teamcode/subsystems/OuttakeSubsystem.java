...
//        pidf.start();
    ...
    public void clawDown() {
        ...
        RobotHardware.getInstance().setServoPos(Names.outtakePivot, 0.11);
    }
    ...
    public void clawSpecimenGrab() {
        RobotHardware.getInstance().setServoPos(Names.outtakeArm, 0.67);
        RobotHardware.getInstance().setServoPos(Names.outtakePivot, 0.35);
    }
