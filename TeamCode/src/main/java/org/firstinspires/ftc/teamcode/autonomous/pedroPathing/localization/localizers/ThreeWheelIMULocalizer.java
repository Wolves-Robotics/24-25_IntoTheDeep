...
public class ThreeWheelIMULocalizer extends Localizer {
    ...
    public static double FORWARD_TICKS_TO_INCHES = 0.0019782001939028052;//8192 * 1.37795 * 2 * Math.PI * 0.5008239963;
    public static double STRAFE_TICKS_TO_INCHES = 0.0019778433154099;//8192 * 1.37795 * 2 * Math.PI * 0.5018874659;
    public static double TURN_TICKS_TO_RADIANS = 0.0018242577098122051;//8192 * 1.37795 * 2 * Math.PI * 0.5;
