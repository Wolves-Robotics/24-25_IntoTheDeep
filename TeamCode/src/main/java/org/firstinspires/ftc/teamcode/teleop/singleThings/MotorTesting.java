...
//        if (gamepad1.a) robotHardware.setMotorPower(Names.frontLeft, 0.25);
//        else robotHardware.setMotorPower(Names.frontLeft, 0);
//        if (gamepad1.b) robotHardware.setMotorPower(Names.backLeft, 0.25);
//        else robotHardware.setMotorPower(Names.backLeft, 0);
//        if (gamepad1.x) robotHardware.setMotorPower(Names.frontRight, 0.25);
//        else robotHardware.setMotorPower(Names.frontRight, 0);
//        if (gamepad1.y) robotHardware.setMotorPower(Names.backRight, 0.25);
//        else robotHardware.setMotorPower(Names.backRight, 0);
    }
}
