...
import org.firstinspires.ftc.teamcode.autonomous.pedroPathing.util.CustomFilteredPIDFCoefficients;
import org.firstinspires.ftc.teamcode.autonomous.pedroPathing.util.CustomPIDFCoefficients;
import org.firstinspires.ftc.teamcode.autonomous.pedroPathing.util.KalmanFilterParameters;
...
public class FollowerConstants {
    ...
    private static double xMovement = 74.153734209337;
    private static double yMovement = 46.737213416379014;
    ...
    public static double mass = 14.61;
    ...
    public static double forwardZeroPowerAcceleration = -26.54784612436933;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -66.34303620604618;
